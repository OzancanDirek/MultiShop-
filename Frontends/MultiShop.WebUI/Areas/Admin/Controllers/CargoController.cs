...
namespace MultiShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class CargoController : Controller
    {
        ...
        {
            await _cargoCompanyService.CreateCargoAsync(createCargoCompanyDto);
        ...
        {
            await _cargoCompanyService.DeleteCargoAsync(id);
            return RedirectToAction("CargoCompanyList", "Cargo", new { Area = "Admin" });
        }
        ...
        {
            var values = await _cargoCompanyService.GetByIdCargoAsync(id);
            return View(values);
        }
        ...
        {
            await _cargoCompanyService.UpdateCargoAsync(updateCargoCompanyDto);
            return RedirectToAction("CargoCompanyList", "Cargo", new { Area = "Admin" });
        }
    }
}
