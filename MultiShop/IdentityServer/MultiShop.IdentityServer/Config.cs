...
namespace MultiShop.IdentityServer
{
    public static class Config
    {
        ...
        {//Scopes
            new ApiScope("CatalogFullPermission","Full authoity for catalog operations"),
            ...
            new ApiScope("CommentFullPermission","Full authoity for comment operations"),
            new ApiScope("PaymentFullPermission","Full authoity for payment operations"),
            new ApiScope("ImageFullPermission","Full authoity for image operations"),
            new ApiScope("OcelotFullPermission","Full authoity for ocelot operations"),
