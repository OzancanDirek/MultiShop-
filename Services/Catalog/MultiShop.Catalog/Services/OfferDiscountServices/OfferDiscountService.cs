...
namespace MultiShop.Catalog.Services.OfferDiscountServices
{
    public class OfferDiscountService :IOfferDiscountService
    {
        ...
        public async Task<GetByIdOfferDiscountDto> GetByIdOfferDiscountAsync(string OfferDiscountId)
        {
            var values = await _offerDiscountCollection.Find<OfferDiscount>(x => x.OfferDiscountId == OfferDiscountId).FirstOrDefaultAsync();
