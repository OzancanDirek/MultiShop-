...
namespace MultiShop.Catalog.Services.BrandServices
{
    public class BrandService : IBrandService
    {
        ...
        public async Task<GetByIdBrandDtos> GetByIdBrandAsync(string BrandId)
        {
            var values = await _BrandCollection.Find<Brand>(x => x.BrandId == BrandId).FirstOrDefaultAsync();
