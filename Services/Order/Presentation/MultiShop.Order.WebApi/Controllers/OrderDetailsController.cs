...
namespace MultiShop.Order.WebApi.Controllers
{
    ...
    public class OrderDetailsController : ControllerBase
    {
        ...
        public OrderDetailsController
            (GetOrderDetailQueryHandler getOrderDetailQueryHandler, GetOrderDetailByIdQueryHandler getOrderDetailByIdQueryHandler,
        ...
        public async Task<IActionResult> UpdateOrderDetail(UpdateOrderDetailCommand command)
        {
            ...
            return Ok("Siparis bilgisi basariyla guncellendi");
        }
        ...
        public async Task<IActionResult> RemoveOrderDetail(int id)
        {
            ...
            return Ok("Siparis bilgisi basariyla silindi");
        }
    }
}
